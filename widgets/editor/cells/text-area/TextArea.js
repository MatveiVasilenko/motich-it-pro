...
const TextArea = ({
    ...
    return (
        <div className={classes.editor__item}>
            ...
            <div className={errors && errors.length > 0 ? [classes.editor__item__textArea, classes.editor__input__error].join(' ') : classes.editor__item__textArea} >
                <textarea placeholder={placeholder} value={dataItem[attribute]} type="text" onChange={(e) => {
                    setDataItem({
                            ...dataItem,
