...
import AnswersView from '../../../../views/office/answers/AnswersView';
import { NET } from './../../../../network';
import HometaskItemView from './../../../../views/office/hometask/HometaskItemView';
...
export async function getServerSideProps({req, params}) {
    ...
    //     `${NET.BACK_URL}/mion/answertask/${params.id}`,
    //     headers,
    // );
